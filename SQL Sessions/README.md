...
1. Set you username and password info in the '.. php\Database.php' file it will not connect to the dbms is you havea password set on your end as the is defaulted to blank
